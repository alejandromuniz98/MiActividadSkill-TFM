...
const LaunchRequestHandler = {
    ...
    async handle(handlerInput) {
        ...
        let speakOutput = 'Bienvenido a mi actividad. Desde aquí podrás consultar los datos que ha recogido tu reloj. ¿Qué quieres que haga? Si no sabes que hacer puedes pedirme ayuda.';
...
const ResumenActividadIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        speakOutput+="¿Qué más quieres que haga?"
...
const ClasificacionIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        //Consultamos la puntuación y la posición del usuario en el partido
...
const ActividadIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        //Obtenemos la fecha de inicio y de fin de la petición en un formato adecuado
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        +'También puedo recopilar esta misma información de otros dispositivos Alexa para hacer un ranking y ver quien es la persona más deportista. '+
        'Para ello prueba a decir ranking o clasificación. Cuando desees salir de la aplicación puedes decir adiós o atrás ¿Qué quieres hacer?';
